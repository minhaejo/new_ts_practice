...
// 라이브러리 로딩
// import 변수명 form "라이브러리 이름"
// 변수 , 함수 임포트 문법
// import from {} "파일 상대 경로"
var axios_1 = require('axios');
//엑시오스를 타입스크립트랑 같이 사용하려고 하는 AxiosResponse 리턴값활용
var chart_js_1 = require('chart.js');
//라이브러리 사용할때 오류났을때 타입데피니션이 필요한데 없는 라이브러리들이 있음
//구글링해서 install해서 해결해야함
// utils
function $(selector) {
  return document.querySelector(selector);
  //쿼리셀럭터의 결과타입이 타입추론이 되기때문
  //별도로 정해주지않으면 타입추론에 의해 ele가 반환되는거
  //자동적으로 추론되는 애들이 el임
  //타입간에 호환이 안되기 때문에 즉 el랑 htmlel랑 htmlprael 랑 다르기때문
  //그래서 돔요소들의 타입단언으로 호환되게 하는거임
}
...
//as로 타입단언을 한 이유 index.html에서 deaths를 찾아보면 p태그인걸 알수있음 $의 반환은 함수로 정의했기에 엘리먼트임
//p태그를 paragraph (문장,단락)El라고 부름
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            fetchCountryInfo(selectedId, CovidStatus.Recoverd),
          ];
        case 2:
